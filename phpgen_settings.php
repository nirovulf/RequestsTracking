...
require_once dirname(__FILE__) . '/' . 'database_engine/ibfbsql_engine.php';
...
function GetGlobalConnectionOptions()
{
    return
        array(
          ...
          'username' => 'SYSDBA',
          'password' => 'masterkey',
          'database' => 'F:\Apps\docs\DOCS_V1.FDB',
...
{
    $result = array();
    $result[] = array('caption' => 'Запросы мед.документации', 'short_caption' => 'Запросы мед.документации', 'filename' => 'request.php', 'name' => 'REQUEST', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
function createConnection()
{
    ...
    $connectionFactory = FbConnectionFactory::getInstance();
